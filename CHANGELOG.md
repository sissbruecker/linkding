...
## v1.8.7 (26/03/2022)
- [**closed**] How to get in touch regarding a security concern [#222](https://github.com/sissbruecker/linkding/issues/222)
- [**closed**] admin interface bookmarks search [#216](https://github.com/sissbruecker/linkding/issues/216)
- [**closed**] Server Error (500) On Login [#200](https://github.com/sissbruecker/linkding/issues/200)
...
- [**closed**] umlaut/non-ascii characters broken when using bookmarklet (firefox) [#148](https://github.com/sissbruecker/linkding/issues/148)
...
- [**closed**] Why is linkding running as user:group 33? [#145](https://github.com/sissbruecker/linkding/issues/145)
...
- [**closed**] Adding bookmarks is slow sometimes [#137](https://github.com/sissbruecker/linkding/issues/137)
...
- [**enhancement**][**good first issue**] Show the version in the settings [#104](https://github.com/sissbruecker/linkding/issues/104)
...
- [**bug**] invalid request block size: 4243 (max 4096)...skip [#28](https://github.com/sissbruecker/linkding/issues/28)
