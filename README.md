...
- Bookmark archive
- Dark mode
- Automatically creates snapshots of bookmarked websites on [the Internet Archive Wayback Machine (archive.org)](https://archive.org/web/) - this can be [disabled](docs/Options.md#ld_disable_background_tasks)
